{
  ...
  auto h_fEdep  = d1.Filter("fEdep>0").Histo1D({"h_fEdep", "Full spectrum", 100, 0., 1.},"fEdep");
  ...
  auto h_fEdep_ROI  = d1.Filter("fEdep>186e-3").Histo1D({"h_fEdep_ROI", "ROI [25eV-10keV]", 50, 0., 1.},"fEdep");
